    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription className="text-center">Enter your details to sign up for a new account</CardDescription>
        </CardHeader>
        <CardContent>
          <form>
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" placeholder="Enter your full name" type="text" className="pl-10" />
                </div>
              </div>
              <div className="space-y-2">
